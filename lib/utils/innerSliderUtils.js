...
var initializedState = exports.initializedState = function initializedState(spec) {
  ...
  var listWidth = spec.listWidth || Math.ceil(getWidth(_reactDom2.default.findDOMNode(spec.listRef)));
  var trackWidth = spec.trackWidth || Math.ceil(getWidth(_reactDom2.default.findDOMNode(spec.trackRef)));
